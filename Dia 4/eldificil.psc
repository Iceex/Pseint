Algoritmo sin_titulo
	...
	correodevoz = 2
		...
		Escribir "1-Inicia sesión como administador"
		Escribir"2-Completar hoja de ingresos mensuales (ingrese la cantidad en número entero)"
		Leer ingresosMensuales
		Escribir "3-Revisa el correo electrónico e ingresa la cantidad de mails sin leer"
		Leer correosTex
		Si correosTex<10 Entonces
			...
			FinSi
		SiNo
			Escribir"Atiende los correos electrónicos"
		FinSi
